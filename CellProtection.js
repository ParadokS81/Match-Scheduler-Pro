...
const PROTECTION_CONFIG = {
  ...
  TEAM_TABS: {
    // Updated to cover new roster block columns.
    // A-D for Meta/Time (4)
    // E-K for Mon-Sun Avail (7)
    // L for Roster Attribute Labels (1)
    // M-V for 10 player data columns (MaxPlayersPerTeam) (10)
    // W for Weekly Changelog (1)
    // Total A-W is 23 columns.
    PROTECTED_RANGE: "A1:W50", 
